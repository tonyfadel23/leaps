...
|------|-------|
| `learn.md` | /learn |
| `explore.md` + `sketches/` | /explore |
| `assess.md` | /assess |
| `prove.md` | /prove |
| `prd.md` | Vibe-coding handoff (created /explore, enriched /assess, /prove) |
| `opportunity.md` | Living doc (created by /learn, enriched by /explore, /assess, /prove) |
...
|-------|----------|------------|-------|-----------|--------------|
| /learn | 4/5 | 3.8/5 | +0.2 | JTBD framing | More competitor context |
| /explore | 5/5 | 3.4/5 | +1.6 | Prototypes | — |
...
|------|----|--------------------|
| `/learn` | `/explore` | JTBD, segment, sizing, open questions |
| `/explore` | `/assess` | Chosen direction, prototype files, journey map |
| `/assess` | `/prove` | KRs, baselines, kill criteria, instrumentation gaps |
| `/prove` | `/ship` | Feasibility verdict, recommended direction, risk register, dependency map |
...
- `/learn` — Problem grinder (has inline Verify phase)
- `/explore` — Lo-fi prototypes (has inline Verify phase)
- `/assess` — Success criteria (has inline Verify phase)
- `/prove` — Feasibility (has inline Verify phase)
- `/prd` — Vibe-coding handoff prompt compilation
- `/ship` — Production prototype (has inline Verify phase)
