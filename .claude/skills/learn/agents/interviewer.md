...
- **Bet** — specific solution hypotheses (comes later in /2 explore, NOT here)
...
**Do NOT run competitor research here.** Competitor analysis happens in `/2 explore`
...
- **Green confidence**: "This is well-grounded. Ready for `/2` to explore the experience? [confirm/redirect]"
- **Yellow confidence**: "We have gaps in [X]. I'd suggest [specific action] before moving on. Want to dig deeper, or move to `/2` anyway?"
