...
Structural checks on /4 prove outputs. Fast pass/fail — flag failures but don't block.
...
**prd.md checks:**
- [ ] `prd.md` updated with the chosen direction's scope (carried from /2, refined by /4)
...
**On failure:** Flag which checks failed. Don't block — these gaps weaken `/5`.
