...
description: >
  ...
  or Replit. Use when a PM says "/prd". Also auto-generated during /explore, /assess, /prove
  Synthesize phases.
...
no new thinking. The pipeline skills (`/explore`, `/assess`, `/prove`) call this logic
...
Run standalone at any point after `/learn` has completed.
...
If `learn.md` or `opportunity.md` doesn't exist, stop: "Run `/learn` first —
...
|----------|-------|-------------|
| [learn.md](learn.md) | /learn | {date} |
| [opportunity.md](opportunity.md) | /learn-/4 | {date} |
| ... | ... | ... |
```
...
3. If not: "No brief found for `{slug}`. Run `/learn` first."
