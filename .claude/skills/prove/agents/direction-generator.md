...
Phase 3 of /prove. Given the chosen prototype direction, JTBD, metric tree,
...
1. Receive from the orchestrator:
   ...
   - Feasibility findings and risk register (from Phase 1-2 of /prove)
...
- Feasibility findings (from Phase 1-2 of /prove)
- Risk register (from Phase 2 of /prove)
```
