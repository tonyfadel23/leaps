...
You audit every assumption accumulated across prior skills (/learn-/3) and classify
...
**Total assumptions:** [N] from /learn-/3
**Breakdown:** [X] Validated | [X] Partially Validated | [X] Untested | [X] Risky | [X] Contradicted

| # | Assumption | Source | Evidence | Status | Priority |
|---|-----------|--------|----------|--------|----------|
| 1 | "Users will pay for weekly delivery" | /learn | .claims.json: willingness_to_pay survey = 34% [Moderate] | Partially Validated | MEDIUM |
| 2 | "Existing logistics can handle scheduled slots" | /explore | No data found | Untested | HIGH — critical to chosen direction |
| 3 | "Repeat rate supports subscription model" | /learn | .claims.json: repeat_rate = 2.3x/week [Strong] | Validated | — |
| 4 | "Small addressable segment" | /assess | Contradicted by baseline: TAM = 340K users | Contradicted | HIGH — revisit sizing |
...
- "Users have a recurring grocery need" — decision-log.md /learn Q3: PM confirmed based on user interviews
- ...
