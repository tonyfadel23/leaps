...
a shareable presentation. Used by every pipeline skill (`/1` through `/5`).
...
|-------|-------------------|-------------|
| `/1 learn` | `summary.md`, `outcomes.md`, `decisions.md` | Summary + Opportunities |
| `/2 explore` | `competitors.md`, `journey.md`, `variations.md` | Competitors + Journey + Variations |
| `/3 assess` | `metrics.md`, `scope.md` | KPIs + Scope |
| `/4 prove` | `feasibility.md` | Feasibility |
| `/5 ship` | `prd.md` | PRD |
...
| Skill | Pages to load |
|-------|---------------|
| /1 learn | summary.md, outcomes.md, decisions.md |
| /2 explore | competitors.md, journey.md, variations.md, decisions.md |
| /3 assess | kpis.md, scope.md, decisions.md |
| /4 prove | feasibility.md, decisions.md |
| /5 ship | decisions.md |
