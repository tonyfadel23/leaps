...
|------|------|-------------|
| **Napkin sizing** | /learn | Fast, rough estimates. How many, how often, how big? |
| **Baselines & instrumentation** | /assess | Precise current-state metrics + assess measurability |
| **Cost & capacity signals** | /prove | Directional cost, infrastructure, and capacity data |
