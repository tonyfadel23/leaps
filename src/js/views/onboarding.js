...
window.OnboardingView = (() => {
      ...
      <div class="onb-rows">
        ...
        <div class="onb-row">
          ...
          <div class="onb-row-b"><div class="onb-row-t">Concepts folder</div>
            <div class="onb-row-d">${esc(s.pipelineDir || st.pipelineDir || 'Where your concepts live. Create one and we’ll make a LEAPs folder in your Documents, or choose your own.')}</div></div>
          <div class="onb-row-actions">
            <button class="onb-btn sm" data-action="create-default-folder">Create one</button>
  ...
  function start() {
    const cmds = [
      ['/learn', 'Start grinding an idea into a sharp problem'],
