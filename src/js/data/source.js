...
window.DataSource = (() => {
  ...
  return { getBoard, getIdea, setVerdict, openArtifact, getPipelineDir, pickPipelineDir, readFile, openExternal,
    getStatus, getConnectors, saveConnectors, applyPreset, signIn, onAuthChanged,
    getSettings, saveSettings, completeOnboarding, checkForUpdates, getContext, saveContext,
