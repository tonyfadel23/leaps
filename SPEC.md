...
|-------|------|--------|------------|
| Interviewer | `learn/agents/interviewer.md` | /learn | One-question-at-a-time JTBD conversation |
| Context Retriever | `learn/agents/context-retriever.md` | /learn | Tribal knowledge from MCPs (KB, ticketing, feedback, support) |
| Doc Analyzer | `_shared/doc-analyzer.md` | /learn, /L | Source document extraction and claim identification |
| Journey Mapper | `explore/agents/journey-mapper.md` | /explore | 4D customer journey (time, social, need, struggle) |
| Journey Renderer | `explore/agents/journey-renderer.md` | /explore | HTML visualization of journey map |
| Competitor Researcher | `explore/agents/competitor-researcher.md` | /explore | Market landscape, screenshots, feature matrices |
| Prototype Builder | `explore/agents/prototype-builder.md` | /explore, /ship | HTML prototypes with your company design tokens (lo-fi + mid-fi) |
| Showcase Builder | `explore/agents/showcase-builder.md` | /explore | Variation explorer + final direction showcase |
| Comparative Critique | `explore/agents/comparative-critique.md` | /explore | 5-dimension scoring (ease, cost, novelty, confidence, impact) |
| Define Interviewer | `assess/agents/assess-interviewer.md` | /assess | Metric tree construction, kill criteria, baselines |
| Architecture Scout | `prove/agents/architecture-scout.md` | /prove | Prior work, system ownership, code patterns |
| Feasibility Interviewer | `prove/agents/feasibility-interviewer.md` | /prove | Constraints + dependency conversation |
| Assumption Auditor | `prove/agents/assumption-auditor.md` | /prove | Pre-interview assumption classification + question gen |
| Direction Generator | `prove/agents/direction-generator.md` | /prove | 3-4 competing directions with KR coverage + formula scoring |
| Feature Analyzer | `prove/agents/feature-analyzer.md` | /prove | Code-level implementation impact analysis |
| Stress Tester | `ship/agents/stress-tester.md` | /ship | 3-lens stress analysis (metrics, kill criteria, risks) |
| Judge | `eval/agents/judge.md` | /eval | LLM-as-Judge quality scoring against rubrics |
| **Data Analyst** | `_shared/data-analyst.md` | /learn,/3,/4,/5,/L,/grill | Sizing, baselines, capacity, instrumentation |
...
├── prd.md                 # Vibe-coding handoff (created /explore, updated /prove)
│
│  ── Skill Outputs (one skill owns each) ──
├── learn.md              # /learn output: JTBD, occasion, outcomes, sizing
├── research-plan.md       # /learn output: user research plan
├── explore.md              # /explore output: journey, directions, variations
├── assess.md              # /assess output: metric tree, baselines, kill criteria
├── prove.md             # /prove output: feasibility, risks, dependencies, directions
│
│  ── Brief Source Pages (per-page brief data) ──
├── summary.md             # /learn+: bet summary, evidence, seeking
├── outcomes.md            # /learn: job, occasion, outcome map
├── competitors.md         # /explore: strategic read, differentiators
├── journey.md             # /explore: direction, stages, intervention
├── variations.md          # /explore: chosen + explored directions
├── metrics.md             # /assess: north star, inputs, kill criteria
├── scope.md               # /assess: ship/don't/later + build context
├── feasibility.md         # /prove: formula scoring, risks, deps
├── decisions.md           # /prove: open/resolved + full Q&A log
│
│  ── Rich Artifacts ──
├── sketches/              # /explore: HTML prototypes + journey map
...
│   └── explore.md
├── competitors/           # /explore: competitor research
│   ├── analysis.md
│   └── screenshots/
├── ship/                 # /ship: mid-fi prototype + release checklist
│   ├── prototype.html
│   ├── showcase.html
...
|------|-----------|----------|---------|
| Summary | `summary.md` | /learn | Bet thesis, evidence, what we're seeking |
| Outcomes | `outcomes.md` | /learn | JTBD, occasion, outcome map |
| Competitors | `competitors.md` | /explore | Strategic read, differentiators, screenshots |
| Journey | `journey.md` | /explore | Direction, stages, intervention points |
| Variations | `variations.md` | /explore | Chosen direction + alternatives explored |
| KPIs | `metrics.md` | /assess | North star, input metrics, kill criteria |
| Scope | `scope.md` | /assess | Build / Don't Build / Later |
| Feasibility | `feasibility.md` | /prove | Formula scoring, risks, dependencies |
| Decisions | `decisions.md` | All | Open/resolved questions + full Q&A log |
| PRD | `prd.md` | /explore,/4 | Vibe-coding handoff prompt |
