...
contextBridge.exposeInMainWorld('leap', {
  ...
  createDefaultFolder: () => ipcRenderer.invoke('leaps:createDefaultFolder'),
  ...
  getModelOptions: () => ipcRenderer.invoke('leaps:getModelOptions'),
  ...
  exportConnectors: (roles) => ipcRenderer.invoke('leaps:exportConnectors', roles),
  importConnectors: () => ipcRenderer.invoke('leaps:importConnectors'),
  checkConnectors: () => ipcRenderer.invoke('leaps:checkConnectors'),
